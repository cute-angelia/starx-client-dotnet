...
namespace StarX
{
  public class Protocol
  {
    ...
    public Protocol(StarXClient c, MyKcp myKcpClient)
    {
      this.starx = c;
      this.transporter = new Transporter(myKcpClient, this.processMessage);
      this.transporter.onDisconnect = onDisconnect;

      // setHandleReceive
      myKcpClient.setHandleReceive(this.transporter);
